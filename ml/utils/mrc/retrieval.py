...
class SparseRetrieval:
    def __init__(
        ...
        # self.bm25 = BM25Okapi(list(map(tokenize_fn, self.contexts)))
    ...
    def retrieve(
        self, query_or_dataset: Union[str, Dataset], topk: Optional[int] = 1, use_bm25=False
    ...
    def get_relevant_doc_bm25(self, queries: List, k: Optional[int] = 1) -> Tuple[List, List]:
